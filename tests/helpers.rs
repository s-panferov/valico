...
pub fn assert_path_str(obj: &Json, path: Vec<&str>, res: &str) {
...
pub fn assert_result_path_str(params: &Builder, body: &str, path: Vec<&str>, res: &str) {
	assert_path_str(&test_result(params, body), path, res);
}

pub fn assert_error_path_str(params: &Builder, body: &str, path: Vec<&str>, res: &str) {
